...
\item[\latexpackage{subcaption}:]
    ...
    replacement for the older \texttt{subfigure} and \texttt{subfig}
    environments.
...
\item[\latexpackage{tabu}:]
    Provides the \texttt{tabu} environment for creating tables, which 
    combines the power of \texttt{longtable}, \texttt{tabularx}, and
    more. This is now preferred to the older \texttt{tabular}
    environment.
